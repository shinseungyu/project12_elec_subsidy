...
export const metadata: Metadata = {
  title: "쿠키 정책 | 전기차 보조금 계산기",
  description: "carelec.kr(전기차 보조금 계산기)의 쿠키 정책입니다. 사용 쿠키 종류, Google AdSense 광고 쿠키, 브라우저별 쿠키 설정 방법을 안내합니다.",
  ...
  return (
    <main className="mx-auto max-w-[800px] px-4 py-12 md:py-20">
      ...
      <div className="prose prose-gray max-w-none text-muted-foreground leading-relaxed">
        <p>carelec.kr(이하 &quot;서비스&quot;)은 원활한 사용자 경험을 제공하기 위해 쿠키(Cookie)를 사용합니다. 쿠키는 웹사이트가 사용자의 브라우저에 저장하는 작은 텍스트 파일입니다.</p>
        ...
        <p>사용자는 브라우저 설정을 통해 쿠키 저장을 거부하거나, 저장된 쿠키를 언제든지 삭제할 수 있습니다. 다만, 필수 쿠키를 거부할 경우 계산기 기능 이용에 일부 제약이 생길 수 있습니다.</p>
        <ul>
        ...
        <p>본 서비스는 Google AdSense, Vercel Analytics 등 제3자 서비스와 연동될 수 있으며, 해당 제3자가 별도의 쿠키를 설정할 수 있습니다. 이러한 쿠키는 각 제3자의 개인정보 처리방침에 따라 관리됩니다. Google 광고 쿠키에 대한 자세한 내용은 <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" className="text-primary underline">Google 개인정보처리방침</a>을 참조하십시오.</p>

        <h2 className="text-xl font-semibold text-foreground mt-8 mb-4">5. 정책 변경 안내</h2>
        <p>본 쿠키 정책은 서비스 변경 또는 관련 법령 개정에 따라 업데이트될 수 있습니다. 중요한 변경이 있을 경우 서비스 내 공지를 통해 안내해 드립니다. 최신 정책은 carelec.kr/cookie-policy 에서 언제든 확인하실 수 있습니다.</p>
